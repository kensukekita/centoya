...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("SailboatCoin-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("SailboatCoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "SailboatCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"115.47.44.19", "115.47.44.19"}, //Main SailboatCoin Seed Node
};
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("SailboatCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("SailboatCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("SailboatCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("SailboatCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. SailboatCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("SailboatCoin-start");
